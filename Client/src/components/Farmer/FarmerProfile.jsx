...
const ProductRatingsSection = ({ farmerId, isDarkMode }) => {
  ...
  return (
    <div
      className="product-ratings-grid"
      style={{
        display: 'grid',
    ...
    >
      {productRatings.map(rating => (
        ...
        >
          <h4
            style={{ margin: '0 0 8px 0', color: isDarkMode ? '#fff' : '#333' }}
          >
            {rating.productName}
          </h4>
          <div
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
              {[1, 2, 3, 4, 5].map(star => (
                <span
                  ...
                  style={{
                    color:
                      star <= Math.round(rating.rating.average)
                        ? '#ffc107'
                        : '#ddd',
                    fontSize: '16px',
                  }}
