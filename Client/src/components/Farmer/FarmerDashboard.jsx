...
const FarmerDashboard = () => {
  ...
  const totalQuantity = (dashboardData.inventory || []).reduce(
  ...
  const chartData = {
    labels: (dashboardData.inventory || []).map(
  ...
  const revenueChartData = {
    labels: (dashboardData.monthlyRevenue || []).map(
      item => item.month || 'Unknown'
    ),
    datasets: [
      {
        label: 'Monthly Revenue',
        data: (dashboardData.monthlyRevenue || []).map(
          item => item.revenue || 0
        ),
    ...
    <div className="dashboard-container">
      ...
      >
        ...
        <div className={`stats-grid ${isDark ? 'text-white' : 'text-black'}`}>
          <div
            className="stat-card primary bg-white dark:bg-gray-900 border-l-4"
          ...
          <div
            className="stat-card success bg-white dark:bg-gray-900 border-l-4"
          ...
          <div
            className="stat-card warning bg-white dark:bg-gray-900 border-l-4"
          ...
          <div
            className="stat-card danger bg-white dark:bg-gray-900 border-l-4"
        ...
        <div
          className={`dashboard-main ${isDark ? 'text-white' : 'text-black'}`}
        >
        ...
        <div
          className={`inventory-section ${isDark ? 'text-white' : 'text-black'} ${isDark ? 'dark' : ''}`}
        >
          <div
          ...
          <div className="inventory-table-container">
            <table className="inventory-table w-full bg-white dark:bg-gray-900 dark:text-white">
              <thead>
                <tr>
                  <th className="bg-gray-100 dark:bg-gray-800 dark:text-white">
                    Product Name
                  </th>
                  <th className="bg-gray-100 dark:bg-gray-800 dark:text-white">
                    Quantity
