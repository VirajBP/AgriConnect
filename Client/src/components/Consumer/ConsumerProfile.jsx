...
const ConsumerProfile = () => {
        ...
        if (response.data.success) {
          ...
          const isComplete = requiredFields.every(
            field =>
              ...
              response.data.data[field].toString().trim() !== ''
          );
  ...
  const fetchCities = async state => {
    try {
      ...
      const response = await axios.get(
        `/api/auth/cities/${encodeURIComponent(state)}`
      );
      if (response.data.success) {
    ...
    if (field === 'password') {
      ...
      try {
        const response = await axios.put(
          '/api/consumer/profile/update-password',
          {
        ...
        if (response.data.success) {
          ...
          const isComplete = requiredFields.every(
            field =>
              ...
              updatedProfile[field].toString().trim() !== ''
          );
          setProfileComplete(isComplete);
    ...
    try {
      ...
      reader.onload = async e => {
        ...
        const response = await axios.post(
          '/api/consumer/profile/upload-photo',
          {
            photoData,
          }
        );
  ...
  return (
    <div className="consumer-profile">
      ...
      />
      <div
        className={`profile-content ${isSidebarCollapsed ? 'sidebar-collapsed' : ''} ${isDarkMode ? 'dark' : ''}`}
      >
        {loading ? (
          <div className="profile-loading">
            <CircularProgress />
              ...
              <div className="profile-main">
                ...
                {!profileComplete && (
                  ...
                  >
                    <div
                      ...
                      style={{ borderBottom: 'none', marginBottom: '1rem' }}
                    >
                    ...
                    <p style={{ margin: 0, fontSize: '1.1rem', opacity: 0.9 }}>
                      Please complete all required fields in your profile to
                      access the full features of AgriConnect. Missing
                      information may prevent you from placing orders or
                ...
                >
                  ...
                  <div className="profile-fields">
                    {/* Name Field */}
                    <div
                      className={`${isDarkMode ? 'profile-field-dark' : 'profile-field'}`}
                    >
                      <div className="field-content">
                        ...
                        <div className="field-info">
                          ...
                          {editMode.name ? (
                            ...
                            <div
                              className={`field-value ${isDarkMode ? 'text-white' : 'text-black'}`}
                            >
                              <span
                          ...
                          {editMode.phoneNumber ? (
                            <div className="field-edit">
                              <input
                                type="tel"
                                value={
                                  tempData.phoneNumber || profile.phoneNumber
                                }
                                onChange={e =>
                                  handleInputChange(
                                    'phoneNumber',
                          ...
                          {editMode.type ? (
                            <div className="field-edit">
                              ...
                              >
                                ...
                                <option value="Corporate Cafeteria">
                                  Corporate Cafeteria
                                </option>
                              </select>
                              <div className="edit-actions">
